...
function show_pop_total(ndx) {
    ...
    var ndx = crossfilter(totalpopData);

    var year_dim = ndx.dimension(dc.pluck('year'));
    var total_population = ndx.dimension(dc.pluck('population'));
    var minYear = totalpopData[0].year;
    var maxYear = totalpopData[57].year;
    
    dc.lineChart("#pop-total")
    .width(1000)
    .height(500)
    .margins({ top: 10, right: 50, bottom: 30, left: 50 })
    .dimension(dim_year).group(total_population)
